...
chmod 644 target/Decimation.jar

cp native/build-aarch64/src/Decimation build/linux-aarch64/
cp target/Decimation.jar build/linux-aarch64/
...
ln -s Decimation AppRun

# Ensure RuneLite is executable to all users
chmod 755 Decimation
popd
