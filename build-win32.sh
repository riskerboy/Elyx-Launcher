...
cp native/build-x86/src/Release/Cryptic.exe build/win-x86/
cp target/Cryptic.jar build/win-x86/
...
echo Cryptic.exe 32bit sha256sum
sha256sum build/win-x86/Cryptic.exe

dumpbin //HEADERS build/win-x86/Cryptic.exe
