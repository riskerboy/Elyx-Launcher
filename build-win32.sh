...
cp native/build-x86/src/Release/Elyx.exe build/win-x86/
cp target/Elyx.jar build/win-x86/
...
echo Elyx.exe 32bit sha256sum
sha256sum build/win-x86/Elyx.exe

dumpbin //HEADERS build/win-x86/Elyx.exe
