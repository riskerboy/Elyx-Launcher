...
cp native/build-x86/src/Release/Decimation.exe build/win-x86/
cp target/Decimation.jar build/win-x86/
...
echo Decimation.exe 32bit sha256sum
sha256sum build/win-x86/Decimation.exe

dumpbin //HEADERS build/win-x86/Decimation.exe
