...
cp native/build-aarch64/src/Release/Elyx.exe build/win-aarch64/
cp target/Elyx.jar build/win-aarch64/
...
echo Elyx.exe aarch64 sha256sum
sha256sum build/win-aarch64/Elyx.exe

dumpbin //HEADERS build/win-aarch64/Elyx.exe
