...
cp native/build-x64/src/Release/Decimation.exe build/win-x64/
cp target/Decimation.jar build/win-x64/
...
echo Decimation.exe 64bit sha256sum
sha256sum build/win-x64/Decimation.exe

dumpbin //HEADERS build/win-x64/Decimation.exe
